import WarningNoticeIcon from '@/pages/guide/assets/illustrations/noticeIcon/warningNoticeIcon.svg?react';
import type { GuideWarningSignTypes } from '@/pages/guide/types/guideTypes';
...
const GuideWarningSignList = ({
  ...
  <div className="flex flex-col gap-2">
    {warningSigns.map(({ description, notice, subDescription, title }) => (
