...
export const GUIDE_DETAILS: GuideDetailTypes[] = [
  ...
  },
  {
    ...
    infoSections: [
      {
        description:
          '대장은 음식물에서 수분을 흡수하는 역할을 해요. 몸에 수분이 부족하면 대장이 변에서 더 많은 물을 가져가면서, 변이 더 단단하고 건조해져요. 이 상태가 계속되면 배출이 어려워지고 변비로 이어질 수 있어요.',
  ...
  },
  {
    ...
    infoSections: [
      ...
      {
        description:
          '커피를 마시면 식후 10분 이내 대장 운동이 빨라진다는 연구들이 있어요. 실제로도 카페인이 없는 디카페인 커피도 비슷한 효과를 보였는데, 이는 카페인 외에 커피 속 다른 성분도 함께 자극한다는 뜻이에요.',
        title: '커피를 마시면 배변 신호가 올까요?',
      },
      {
        description:
