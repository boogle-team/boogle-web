...
const LoginToast = ({ message }: LoginToastPropTypes) => {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed bottom-[calc(2rem+env(safe-area-inset-bottom))] left-1/2 z-50 flex w-[calc(100%-2rem)] max-w-[24.875rem] -translate-x-1/2 items-center gap-3 rounded-xl bg-orange-1 px-4 py-3 text-orange-6 shadow-md"
    >
